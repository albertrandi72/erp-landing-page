...
export default function Header({ handleLogin }: { handleLogin: () => void }) {
    ...
    return <div>
        <div className="hidden lg:flex py-6 px-12 text-white">
            ...
            <div className="flex flex-1 flex-row-reverse gap-x-12 text-3xl font-bold">
                <div className=" cursor-pointer text-[#8BE8FF] border-[#8BE8FF] border-solid border-4 font-bold px-8 -mt-0.5 py-1 text-lg rounded-xl" onClick={handleLogin}>Login</div>
                <div>Contact</div>
                <div>Pricing</div>
                <div>About</div>
            </div>
